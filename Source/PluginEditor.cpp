...
ResponseCurveComponent::ResponseCurveComponent(ProvaDSPAudioProcessor& p) : audioProcessor(p)
{
...
std::vector<juce::Component*> ProvaDSPAudioProcessorEditor::getComps()
{
    return
    {
        &peakFreqSlider,
